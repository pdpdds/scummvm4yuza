...
OSystem_SDL::~OSystem_SDL() {
	...
	_savefileManager = 0;
	if (_graphicsManager) {
		_graphicsManager->As<SdlGraphicsManager>()->deactivateManager();		
	}
...
void OSystem_SDL::initBackend() {
	...
	// manager.
	_graphicsManager->As<SdlGraphicsManager>()->activateManager();
}

void OSystem_SDL::engineInit() {
#if SDL_VERSION_ATLEAST(2, 0, 0)	
	_graphicsManager->As<SdlGraphicsManager>()->unlockWindowSize();
#endif
#ifdef USE_TASKBAR
