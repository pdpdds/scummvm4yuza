...
protected:
	 ...
	 */
	class Track : public Common::RTTI {
		RTTI_DECLARATIONS(Track, RTTI)
	public:
		Track();
		virtual ~Track() {}
	...
	class VideoTrack : public Track {
		RTTI_DECLARATIONS(VideoTrack, Track)
	public:
		VideoTrack() {}
		virtual ~VideoTrack() {}
	...
	class FixedRateVideoTrack : public VideoTrack {
		RTTI_DECLARATIONS(FixedRateVideoTrack, VideoTrack)
	public:
		FixedRateVideoTrack() {}
	...
	class AudioTrack : public Track {
		RTTI_DECLARATIONS(AudioTrack, Track)
	public:
	...
	class RewindableAudioTrack : public AudioTrack {
		RTTI_DECLARATIONS(RewindableAudioTrack, AudioTrack)
	public:
	...
	class SeekableAudioTrack : public AudioTrack {
		RTTI_DECLARATIONS(SeekableAudioTrack, AudioTrack)
	public:
